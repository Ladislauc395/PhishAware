...
const _privacyPolicy = _LegalContent(
  ...
  sections: [
    _LegalSection(
        ...
        body:
            'A PhishAware recolhe apenas os dados estritamente necessários para o funcionamento da aplicação: nome de utilizador, endereço de email, e os resultados das simulações que completas (respostas correctas, incorrectas, pontos XP e categorias).\n\nNão recolhemos dados de localização, contactos, câmara ou qualquer outro dado sensível do dispositivo.'),
    _LegalSection(
    ...
    _LegalSection(
        ...
        body:
            'Os teus dados são armazenados num servidor local protegido. Utilizamos práticas de segurança standard para proteger as tuas informações contra acesso não autorizado. As passwords são armazenadas com hash e nunca em texto simples.'),
    _LegalSection(
    ...
    _LegalSection(
        ...
        body:
            'Os teus dados são mantidos enquanto a tua conta estiver activa. Ao eliminares a conta, todos os dados são removidos permanentemente e de forma irreversível dos nossos servidores no prazo de 24 horas.'),
    _LegalSection(
        heading: '6. Contacto',
        body:
            'Se tiveres dúvidas sobre esta política, podes contactar-nos através do suporte da aplicação. Comprometemo-nos a responder no prazo de 5 dias úteis.'),
  ],
);
...
const _termsOfService = _LegalContent(
  ...
  sections: [
    _LegalSection(
        ...
        body:
            'Ao criares uma conta e utilizares a PhishAware, aceitas estes Termos de Serviço na íntegra. Se não concordares com alguma parte destes termos, deves descontinuar o uso da aplicação.'),
    _LegalSection(
        heading: '2. Utilização Permitida',
        body:
            'A PhishAware é uma plataforma educativa de simulação de ciberameaças. Podes utilizar a aplicação para:\n\n• Treinar a tua capacidade de identificar ataques de phishing\n• Aprender sobre segurança digital\n• Competir no ranking global de forma justa\n\nÉ expressamente proibido utilizar os conteúdos da aplicação para fins maliciosos, enganosos ou ilegais.'),
    _LegalSection(
        heading: '3. Conteúdo Educativo',
        body:
            'Todos os cenários de simulação presentes na aplicação são fictícios e criados exclusivamente para fins educativos. Qualquer semelhança com situações reais é coincidência.\n\nOs cenários baseiam-se em técnicas documentadas publicamente por investigadores de segurança e não constituem instrução para actividades ilegais.'),
    _LegalSection(
        heading: '4. Conta e Segurança',
        body:
            'És responsável por manter a confidencialidade da tua password e por todas as actividades realizadas na tua conta. Deves notificar-nos imediatamente se suspeitares de acesso não autorizado.\n\nReservamo-nos o direito de suspender contas que violem estes termos ou que apresentem comportamentos abusivos.'),
    _LegalSection(
        heading: '5. Ranking e Competição',
        body:
            'O ranking global deve ser utilizado de forma justa. É proibido:\n\n• Usar ferramentas automáticas para ganhar XP\n• Manipular resultados de qualquer forma\n• Criar múltiplas contas para benefício no ranking\n\nContas com actividade suspeita podem ser removidas do ranking ou suspensas.'),
    _LegalSection(
        heading: '6. Disponibilidade do Serviço',
        body:
            'A PhishAware é disponibilizada "tal como está". Não garantimos disponibilidade ininterrupta do serviço e reservamo-nos o direito de efectuar manutenções ou actualizações sem aviso prévio.'),
    _LegalSection(
        heading: '7. Alterações aos Termos',
        body:
            'Podemos actualizar estes Termos de Serviço periodicamente. Quando o fizermos, actualizaremos a data de "Última actualização". O uso continuado da aplicação após alterações constitui aceitação dos novos termos.'),
  ],
);
          ...
          Padding(
            ...
            child: Row(children: [
              Container(
                  ...
                  height: 44,
                  decoration: BoxDecoration(
                      color: AppColors.accent.withValues(alpha: 0.059),
                      borderRadius: BorderRadius.circular(12),
                      border: Border.all(
                          color: AppColors.accent.withValues(alpha: 0.157))),
                  child: Center(
                      child: Text(content.icon,
              ...
              return Padding(
                ...
                child: Column(
                    ...
                    children: [
                      ...
                      Divider(
                          height: 1,
                          color: AppColors.border.withValues(alpha: 0.392)),
                    ]),
              );
            },
          )),
...
class _SettingsScreenState extends State<SettingsScreen>
  ...
  Future<void> _loadPrefs() async {
    ...
    SoundManager.setEnabled(AppPreferences.hapticEnabled);
    try {
  ...
  Future<void> _toggleRanking(bool v) async {
    ...
    try {
      ...
      _snack(
          v
              ? 'Voltaste a aparecer no ranking! 🏆'
              : 'Removido do ranking global',
  ...
  Future<void> _deleteAccount() async {
    final step1 = await showDialog<bool>(
        ...
        builder: (_) => _ConfirmDialog(
            ...
            message:
                'Esta acção é irreversível. Todos os teus dados, progresso e histórico serão eliminados permanentemente.',
                ...
                children: [
                    ...
                    _SettingsCard(children: [
                      _ToggleRow(
                          ...
                          title: 'Vibração / Haptic',
                          subtitle: 'Feedback táctil nas interacções',
                          value: _haptic,
                      ...
                      _ToggleRow(
                          ...
                          title: 'Animações XP',
                          subtitle: 'Animações ao ganhar pontos',
                          value: _xpAnim,
                          onChanged: _toggleXpAnim),
                    ]),
                    ...
                    _SettingsCard(children: [
                      _ToggleRow(
                          ...
                          value: _ranking,
                          loading: _savingRanking,
                          onChanged: _toggleRanking),
                    ]),
                    const SizedBox(height: 20),
                    _SectionLabel('Conta'),
                    const SizedBox(height: 10),
                    _SettingsCard(children: [
                      ...
                      _InfoRow(
                          ...
                          iconColor: AppColors.accent,
                          title: 'Email',
                          value: UserSession.userEmail.isNotEmpty
                              ? UserSession.userEmail
                              : '—'),
                      _Divider(),
                      _InfoRow(
                    ...
                    _SettingsCard(children: [
                      ...
                      _TappableRow(
                          ...
                          title: 'Política de Privacidade',
                          onTap: () =>
                              _showLegalSheet(context, _privacyPolicy)),
                      _Divider(),
                      _TappableRow(
                          icon: '📄',
                          iconColor: AppColors.textMuted,
                          title: 'Termos de Serviço',
                          onTap: () =>
                              _showLegalSheet(context, _termsOfService)),
                    ]),
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                          ...
                          gradient: LinearGradient(
                              colors: [
                                AppColors.danger.withValues(alpha: 0.031),
                                AppColors.bg
                              ],
                                  ...
                                  SizedBox(
                                      ...
                                      child: OutlinedButton.icon(
                                          ...
                                          icon: const Icon(Icons.delete_forever,
                                              size: 16,
                                              color: AppColors.danger),
                                          label: Text('Eliminar a Minha Conta',
                                              style: GoogleFonts.inter(
                                                  color: AppColors.danger,
                                                  fontWeight: FontWeight.w600,
                                                  fontSize: 13)),
        ...
        child: Padding(
            ...
            child: Column(mainAxisSize: MainAxisSize.min, children: [
              ...
              TextField(
                  ...
                  autofocus: true,
                  onChanged: (v) =>
                      setState(() => _valid = v.trim() == firstName),
                  style: GoogleFonts.spaceGrotesk(
              ...
              Row(children: [
                ...
                Expanded(
                    child: ElevatedButton(
                        onPressed:
                            _valid ? () => Navigator.pop(context, true) : null,
                        style: ElevatedButton.styleFrom(
                            padding: const EdgeInsets.symmetric(vertical: 14),
                            backgroundColor: AppColors.danger,
                            disabledBackgroundColor:
                                AppColors.danger.withValues(alpha: 0.157),
                            shape: RoundedRectangleBorder(
                                borderRadius: BorderRadius.circular(12))),
                        child: Text('Eliminar',
                            style: GoogleFonts.inter(
  ...
  Widget build(BuildContext context) => Padding(
      ...
      child: Row(children: [
        Container(
            ...
            height: 36,
            decoration: BoxDecoration(
                color: iconColor.withValues(alpha: 0.078),
                borderRadius: BorderRadius.circular(10)),
            child: Center(
        ...
        if (loading)
          ...
          Switch(
              ...
              activeTrackColor: AppColors.accent.withValues(alpha: 0.157),
