...
// AppPreferences está em models/app_models.dart
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          'Última actualização: ${content.lastUpdated}',
...
class _SettingsScreenState extends State<SettingsScreen>
  ...
  Future<void> _toggleDarkMode(bool v) async {
    ...
    _snack(
      v ? 'Modo escuro activado' : 'Modo claro activado',
      AppColors.accent,
    );
  }
  ...
  Future<void> _toggleXpAnim(bool v) async {
    ...
    _snack(
      v ? 'Animações XP activadas' : 'Animações XP desactivadas',
  ...
  Future<void> _toggleRanking(bool v) async {
    ...
    try {
      ...
      if (!mounted) return;
      _snack(
        v ? 'Voltaste a aparecer no ranking! 🏆' : 'Removido do ranking global',
